...
<v-layout>
  ...
  <v-dialog v-model="dialog" persistent>
    <v-card class="text-xs-left">
      ...
      <v-card-text>
        ...
        Un cookie est un petit fichier texte que les sites web sauvegardent sur votre appareil lorsque vous les consultez. Il permet à ces sites de mémoriser des informations pendant un temps donné, et sont supprimés au bout de 13 mois maximum.

        <h3 class="mt-3">Quels sont les cookies utilisés par ce site ?</h3>
        Les services suivants utilisent des cookies:
        <ul>
        ...
        <h3 class="mt-3">Comment contrôler l'utilisation des cookies ?</h3>
        Vous pouvez autoriser ou interdire l'utilisation des cookies dans les préférences de votre navigateur internet. Voici des instructions pour les principaux navigateurs:
        <ul>
        ...
        Notez que si vous refusez l'utilisation des cookies, vous pourrez toujours naviguer sur ce site.
      </v-card-text>
      <v-card-actions>
        <v-spacer></v-spacer>
  ...
  auto-height
  :timeout=0>
    En poursuivant votre navigation sur ce site, vous acceptez l'utilisation de cookies pour analyser le traffic et vous proposer du contenu de meilleure qualité.
    <v-btn flat @click="dialog = true; snackbar = false">
      en savoir plus
    </v-btn>
    <v-btn flat @click="snackbar = false; setCookiesAccepted()">
      OK
    </v-btn>
  </v-snackbar>
</v-layout>
